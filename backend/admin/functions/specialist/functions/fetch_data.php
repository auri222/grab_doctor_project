...
$query = ' SELECT ck.id, ck.name FROM chuyenkhoa ck
';
    ...
    while($row = mysqli_fetch_assoc($rs)){
        $output .= '
            <tr>
                ...
                <td class="text-center">
                    <button type="button" class="btn btn-info btn-edit" data-spec_id="'.$row['id'].'" >Sửa</button>
                    <button type="button" class="btn btn-danger btn-del" data-spec_id="'.$row['id'].'">Xóa</button>
                </td>
             </tr>
        ';
    }
...
$output .= $previous_page.$current_page.$next_page;
    ...
    $output .= '
    <tr>
        <td colspan="3" align="center">Chưa có chuyên khoa nào</td>
    </tr>
    ';
}
