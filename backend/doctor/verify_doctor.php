      ...
      <div class="col-12 col-md-8 col-xl-6 content">
        <div class="wrapper px-3 pt-3 pb-4 ">
          ...
          <div class="text-center alert alert-success my-2">
            Bạn đã xác nhận tài khoản thành công !! Vui lòng đăng nhập lại!!
          </div>
          <a href="/nln_test/frontend/forms/login/logout.php" class="badge badge-info">Quay lại TRANG CHỦ</a> <br/>
          <a href="/nln_test/frontend/forms/login/login.php" class="badge badge-info">Quay lại TRANG ĐĂNG NHẬP</a>
          <?php else: ?>
